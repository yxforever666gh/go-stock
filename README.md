...
Go-Stock 是基于 Go、Vue 3、Naive UI 和 SQLite 的本地股票行情与 AI 研究工具。本版本在可审计证据与多资产行情基础上，增加统一的专业 K 线、技术指标、研究复盘与可恢复绘图能力。
