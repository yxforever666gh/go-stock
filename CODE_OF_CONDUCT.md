...
若发生滥用、骚扰或其他不可接受的行为，可通过当前仓库的 [GitHub Issues](https://github.com/yxforever666gh/go-stock/issues) 联系维护者。所有投诉都将得到及时、公正的审查和调查。
...
reported to the maintainers through [GitHub Issues](https://github.com/yxforever666gh/go-stock/issues).
