...
import {darkTheme, lightTheme, dateZhCN, zhCN, NIcon, NText} from 'naive-ui'
import {
  AlarmOutline,
  AnalyticsOutline,
...
import {AnalyzeSentiment, GetConfig, GetGroupList, GetVersionInfo} from "./services/app-api";
          ...
          h(
              RouterLink,
              {
                ...
                onClick: () => {
                  ...
                  setTimeout(() => {
                    EventsEmit("changeResearchTab", {ID: 0, name: '股票收益率'})
                  }, 100)
                },
              },
              {default: () => '研究中心'}
