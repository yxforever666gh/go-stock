...
import {tradingDaySeparatorIndexes, weightedExecutionPrice} from '../utils/prediction-trade-chart.js'
...
export function adaptPredictionChart(chartData = {}) {
...
export function predictionChartOverlays(model, trades = [], {showPriceLines = false} = {}) {
