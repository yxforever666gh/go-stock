...
export const ListAISimulatedAccountCashFlows = () => requestJSON(API_PATHS.listAccountCashFlows)
export const GetAISimulatedAccountPerformance = () => requestJSON(API_PATHS.getAccountPerformance)
