...
import type {RecommendationChart, Research2AccountOverview, Research2AnalysisRun, Research2AnalysisRunSummary, Research2Performance, Research2PortfolioPerformance, Research2Recommendation, Research2RecommendationDetail} from './api-types.generated'
...
export const ListResearch2PerformanceRecommendations = (limit = 100, offset = 0, slots: string[] = [], from = "", to = ""): Promise<Research2Recommendation[]> => requestJSON(withQuery(API_PATHS.listResearch2Recommendations, {limit, offset, slots: slots.join(','), from, to, boughtOnly: true}))
...
export const GetResearch2PortfolioPerformance = (slots: string[] = [], from = "", to = ""): Promise<Research2PortfolioPerformance> => requestJSON(withQuery(API_PATHS.getResearch2PortfolioPerformance, {slots: slots.join(','), from, to}))
