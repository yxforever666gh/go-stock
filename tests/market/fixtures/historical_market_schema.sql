...
CREATE TABLE IF NOT EXISTS market_theme_aliases (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS market_theme_daily_snapshots (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS market_catalyst_events (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS market_catalyst_source_claims (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS market_theme_snapshot_catalysts (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  snapshot_id TEXT NOT NULL,
  catalyst_event_id TEXT NOT NULL,
  created_at DATETIME NOT NULL
...
CREATE TABLE IF NOT EXISTS market_theme_snapshot_constituents (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS market_theme_evidence_links (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS chart_drawing_documents (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS chart_drawing_revisions (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
