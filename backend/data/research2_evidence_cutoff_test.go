...
func TestResearch2CollectForRunCreatesBatchWithActualCutoff(t *testing.T) {
	...
	collector := &Research2EvidenceCollector{
		evidence: repository, evidenceProfile: research2EvidenceProfileV5,
	...
	if batch.EvidenceProfileVersion != research2EvidenceProfileV5 || batch.Status != marketdata.StatusFrozen {
